...
urlpatterns = [
    ...
    path('change-initial-password/', views.change_initial_password_view, name='change_initial_password'),
    ...
    # Alias for attachment admin dashboard (separate template rendering based on role)
    path('attachment-admin/dashboard/', views.admin_dashboard_view, name='attachment_admin_dashboard'),

...
# Email configuration — prefer Mailgun via Anymail (API) with SMTP fallback
# For local development (DEBUG=True) default to the console backend to avoid
# requiring django-anymail to be installed.
if DEBUG:
...
# Keep SMTP settings available as a fallback if you prefer SMTP
EMAIL_HOST = os.environ.get('EMAIL_HOST', 'smtp.mailgun.org')
EMAIL_PORT = int(os.environ.get('EMAIL_PORT', '587'))
EMAIL_USE_TLS = os.environ.get('EMAIL_USE_TLS', 'True').lower() in {'true', '1', 'yes'}
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER', '')
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD', '')
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', f"Attachment Office <no-reply@{os.environ.get('MAILGUN_SENDER_DOMAIN','example.com')}>")
